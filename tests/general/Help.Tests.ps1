...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\PIM.Graph\functions", "$global:testroot\..\PIM.Graph\internal\functions"),
	
	[string]
	$ModuleName = "PIM.Graph",
...
$CommandPath = @(
    "$global:testroot\..\PIM.Graph\functions"
    "$global:testroot\..\PIM.Graph\internal\functions"
)
