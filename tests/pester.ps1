...
Remove-Module PIM.Graph -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PIM.Graph\PIM.Graph.psd1"
Import-Module "$PSScriptRoot\..\PIM.Graph\PIM.Graph.psm1" -Force
